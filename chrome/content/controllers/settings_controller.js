(function () {
    ...
    const __controller__ = {
        ...
        readSettings: function () {
            let settings = {};
            settings = GeckoJS.Configure.read(
                'vivipos.fec.settings.skypay_promotion'
            );
            return settings;
        },
        ...
        save: function () {
            ...
            $do('validateForm', data, 'SkypayPromotionSettings');
            ...
            if (data.changed) {
                ...
                if (
                    ...
                    try {
                        ...
                        this.log(
                            'WARN',
                            'Error saving settings to preferences.',
                            e
                        );
                    } finally {
